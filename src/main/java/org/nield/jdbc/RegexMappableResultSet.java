...
public final class RegexMappableResultSet implements ResultSet {
    ...
    private final HashMap<String,Integer> cachedIndices = new HashMap<String,Integer>(); //-1 means unfound
    ...
    public int findColumn(String columnRegex) throws SQLException {
            ...
            if (foundIndex.equals(-1)) {
                throw new ColumnMatchNotFoundException(new SQLException("Column for pattern ".concat(columnRegex).concat(" not found")));
            }
            return foundIndex + 1;
    }
